...
<div class="row">
    <div class="col-lg-9 overflow-hidden" style="height: 542px;" id="vertical-example">
        <h3><?php echo e($noDisplayMessage); ?></h3>
        <p><?php echo e($subMessage); ?></p>
        <div class="row row-cols-1 row-cols-md-4 g-4 mb-2">
            ...
            <div class="col">
                <div class="card card-pullup" data-bs-toggle="offcanvas"
                    data-bs-target="#offcanvasEnd<?php echo e($book->bookID); ?>" aria-controls="offcanvasEnd"
                    style="cursor: pointer">
                    <img class="card-img-top h-px-325" src="<?php echo e(asset('/images/books/' . $book->bookIMG)); ?>"
                        alt="Card image cap" />
                    <div class="card-body">
                        <h5 class="card-title"><strong><?php echo e($book->bookTitle); ?></strong></h5>
                        <small><b>Author: </b><?php echo e($author->firstName); ?> <?php echo e($author->lastName); ?></small><br>
                        <small><b>Category: </b><?php echo e($theCategory->categoryName); ?> </small><br>
                        <small><b>Publisher: </b><?php echo e($book->bookPublisher); ?> </small><br>
                        <small><b>Year published: </b><?php echo e($book->bookPublicationYear); ?> </small><br>
                        <p class="card-text"><small class="text-muted"><?php echo e($isActive->status); ?></small></p>
                    </div>
                </div>
            </div>
            
            <div class="offcanvas offcanvas-end mt-n1" tabindex="-1" id="offcanvasEnd<?php echo e($book->bookID); ?>"
                ...
                <br>
                <p class="mx-4"><small class="text-muted"><b>Written by: </b><?php echo e($author->firstName); ?> <?php echo e($author->lastName); ?>
                ...
                <div class="padding-canvas-footer mx-4 my-4">
                    ...
                    <a type="button" class="btn btn-primary mb-2 d-grid w-100" target="_blank"
                        href="<?php echo e($book->bookURL); ?>">See
                        review</a>
                    <?php endif; ?>
                        ...
                        <div class="row mb-3" style="padding-left: 6px">
                            <div class="col-12">
                                <button class="btn btn-info btn-md"
                                    onclick="window.location.href='<?php echo e(route('category')); ?>'" style="min-width: 280px"
                                    type="button">
    ...
    <div class="modal-dialog modal-md modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post" action="<?php echo e(route('registerOnDash')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col mb-3">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/contentNavbarLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\tishas-book-club\resources\views/content/dashboard/dash2.blade.php ENDPATH**/ ?>