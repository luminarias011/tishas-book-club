...
<nav
          ...
          <div class="navbar-nav align-items-center">
            <form action="">
              <div class="nav-item d-flex align-items-center">
                ...
                <a class="btn " href="<?php echo e(config('variables.booksPage')); ?>">
                  BOOK DISPLAY
                </a>
                <a class="btn btn-outline-dark" href="<?php echo e(config('variables.managePage')); ?>">
                  MANAGE
                </a>
  ...
  <!-- / Navbar --><?php /**PATH C:\laragon\www\tishas-book-club\resources\views/layouts/sections/navbar/navmanage.blade.php ENDPATH**/ ?>