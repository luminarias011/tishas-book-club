          ...
          <div class="navbar-nav align-items-center">
            <form action="">
              <div class="nav-item d-flex align-items-center">
                <a class="btn btn-outline-dark" style="color: black" href="{{ config('variables.livePreview') }}">
                  HOME
                </a>
                <a class="btn " style="color: black" href="{{ config('variables.booksPage') }}">
                  BOOK DISPLAY
                </a>
                <a class="btn " style="color: black" href="{{ config('variables.managePage') }}">
                  MANAGE
                </a>
